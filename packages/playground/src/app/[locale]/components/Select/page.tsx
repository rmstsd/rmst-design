...
export default function SelectDd() {
  return (
    <div className="flex flex-col items-start gap-[10px] ">
      ...
      <Select size="default" options={options2} placeholder="Select readOnly" readOnly></Select>

      <Select size="large" options={options2} placeholder="Select disabled" disabled></Select>
    </div>
  )
}
